...
const linkFor=t=>{recordUsage('run');const c=affiliate[t.key];return c&&c.enabled&&c.url?{url:c.url,rel:'noopener sponsored',paid:true}:{url:t.url,rel:'noopener',paid:false}};
